...
6. **Movimiento discreto.** Cero dependencias de animación. Transiciones de 130–190 ms y
...
| `--t-2xl` | 1.75 → 2.625 rem | `h1` de guía |
...
| `--r-xl` | 20 px | superficies grandes: hero, tarjeta de track |
...
| --- | --- | --- |
| `Hero` | portada | el único sitio con degradado sobre texto |
| `Countdown` | cuenta atrás | el servidor pinta ya los valores: sin parpadeo de ceros |
| `TrackCard` | tarjeta de track | franja superior con el color del track |
...
| `RoleBadge` | roles del equipo | Frontend · Backend · Cloud · BD · Docs |
...
—no los valores que creíamos haber definido—. **32 de 32 pares cumplen WCAG AA en ambos temas.**

| Elemento | Oscuro | Claro | Mínimo |
| --- | ---: | ---: | ---: |
| Titular del hero | 19.43:1 | 17.85:1 | 3:1 |
| Dato destacado | 17.74:1 | 17.06:1 | 4.5:1 |
...
| Pie | 7.58:1 | 4.76:1 | 4.5:1 |
| **Nota secundaria / etiquetas** | 6.92:1 | **4.55:1** | 4.5:1 |
...
- **Foco visible** en todo elemento interactivo: 2 px de naranja con 3 px de separación.
- **Objetivos táctiles** de 44 px de alto mínimo en botones.
- **Un solo `h1` visible por página** (Starlight añadía un segundo en la portada; se oculta).
- **Movimiento reducido** respetado: con la preferencia activa no queda ninguna animación.
- **Sin desbordamiento horizontal** a 390, 768 ni 1440 px.
